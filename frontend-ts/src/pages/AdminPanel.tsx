...
const AdminPanel = () => {
  ...
  return (
    <div className="min-h-screen bg-bg-page text-text-main">
      <Header />
      <div className="bg-[linear-gradient(135deg,#1e1b4b_0%,#312e81_50%,#4338ca_100%)] px-6 py-8 text-white"><div className="max-w-[1280px] mx-auto"><div className="flex items-center gap-1.5 text-[0.82rem] mb-2 text-white/65"><a href="/" className="text-white/85 no-underline hover:underline">{t('admin.breadcrumbHome')}</a><span>/</span><span>Admin</span></div><h1 className="m-0 text-2xl font-extrabold">{t('admin.dashboardTitle')}</h1><p className="mt-1 mb-0 text-white/70 text-sm">{t('admin.dashboardDesc')}</p></div></div>
