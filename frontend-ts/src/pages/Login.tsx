...
const Login = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-bg-page flex items-center justify-center p-5 animate-[fadeIn_0.6s_ease-out]">
      <div className="grid grid-cols-2 w-full max-w-[960px] min-h-[600px] rounded-3xl overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.1)] animate-[slideUp_0.6s_ease-out] max-md:grid-cols-1 max-md:max-w-[440px]">
        {/* Branding */}
